                    ...
                    <form method="POST" action="{{ route('admin.rooms.store') }}" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="room_number" class="block mt-1 w-full" type="text" name="room_number" :value="old('room_number')" 
                            ...
                            <div>
                                ...
                                <select id="type" name="type" class="block mt-1 w-full rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" required onchange="updateCapacity()">
                                    ...
                                    <option value="Single Bedroom" {{ old('type') === 'Single Bedroom' ? 'selected' : '' }}>Single Bedroom</option>
                                    <option value="Double Bedroom" {{ old('type') === 'Double Bedroom' ? 'selected' : '' }}>Double Bedroom</option>
                                </select>
                            ...
                            <div>
                                ...
                                <x-text-input id="capacity" name="capacity" class="block mt-1 w-full bg-gray-100" type="number" :value="old('capacity', '')" readonly placeholder="Select room type first" />
