        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form action="{{ route('room-assignments.index') }}" method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
                        <div>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @forelse($assignments as $assignment)
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                            ₱{{ number_format($assignment->monthly_rent, 2) }}
                                        </td>
                                    ...
                                    <tr>
                                        <td colspan="7" class="px-6 py-4 text-center text-sm text-gray-500">
                                            <div class="flex flex-col items-center justify-center py-8">
                                                ...
                                                <p class="text-lg font-medium text-gray-900 mb-1">No room assignments found</p>
                                                <p class="text-gray-500">Get started by creating a new room assignment.</p>
                                            </div>
                                        </td>
                                    </tr>
                                @endforelse
